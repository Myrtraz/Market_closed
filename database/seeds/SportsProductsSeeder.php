...
class SportsProductsSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	'description' => 
    	'****LA NUEVA ROADMASTER JUMPER 29" MODELO 2020*** RoadMaster trae para ti Bicicleta Roadmaster Jumper Doble Susp RIN 29 Shimano21v.
    	...
    	'description' => 
    	'SOMOS AKAESCOLOMBIA SAS
		TODOS NUESTROS PRODUCTOS SON IMPORTADOS Y EL TIEMPO DE ENTREGA ES DE 9 A 11 DÍAS HÁBILES.',
    	'prices' => '152900',
    	'quantity' => '1',
    	...
    	'description' => 
    	'Balon Futbol tamaño numero 5 Original Mikasa
