...
class ShirtsProductsSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	'description' => 
        'Talla única, se ajusta a mujeres de talla S y M por su tela strech. Mide 60 cm de largo',
    	'prices' => '25000',
    	'quantity' => '10',
        ...
        'description' => 
        '• La tela de esta prenda es suave
        ...
        • Horma de esta prenda es para dama',
        'prices' => '34111',
        'quantity' => '100',
        ...
        'description' => 
        'Las fotos son reales no tienen ningún tipo de retoque para que la compra sea con confianza, viendo directamente de lo que usted va a recibir.
        Si tiene preguntas sobre el producto, puede hacer todas las que guste.
        Totalmente nueva y nunca ha sido usada.

        No se suministraran mas fotos a la plataforma de Mercadolibre, si desea puede hacer la compra y recogerla en nuestro local para verificar su compra, si no esta conforme de alguna manera se le hará la devolución inmediata del dinero o cambio de producto.',
        'prices' => '41900',
        'quantity' => '31',
        ...
        'description' => 
        'Camisetas Largas con capucha Urban
        ...
        (Mercado libre en su plataforma no permite la opción de comprar dos productos de diferente color)',
        'prices' => '39999',
        'quantity' => '64',
