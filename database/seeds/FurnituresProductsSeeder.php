...
class FurnituresProductsSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	'description' => 
    	'SALA RIÑONERA PEQUEÑA DE 1.70 X 1.70
		...
		- Puff central,
		La sala esta tapizada en tela tipo cuero fácil de limpiar, se puede fabricar en el color y combinación que usted desee, somos fabricantes, se lleva a domicilio dentro de Bogotá sin ningún costo, se hacen envios nacionales.',
    	'prices' => '559000',
    	'quantity' => '10',
    	...
    	'description' => 
    	'Medidas: Alto: 181cm x Ancho: 63cm x Profundidad: 24cm
		Estilo: moderno.
		Material: madera.
		...
		- Opción Obsequio 2 (MesaPuff): 40 x 40 x 40cm.',
    	'prices' => '159900',
    	'quantity' => '100',
    	...
    	'description' => 
    	'PRODUCTO: Escritorio Ref: Sevilla
		...
		GARANTÍA: 2 años.
		MATERIAL: Madera de cedro y Mdf.',
    	'prices' => '645000',
    	'quantity' => '10',
