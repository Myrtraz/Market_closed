...
class HeadphonesProductsSeeder extends Seeder
{
    ...
    Sales::create([
    	...
    	'description' => 
    	'Características de los AirDots:
		- Bluetooth 5.0
		- Peso de 4,1 gramos
		...
		- Es un producto con una buena relación costo/beneficio. para detalles especificos como cancelación de ruido, sincronización, posición del microfono, calidad de las llamadas, recomendación verificar reviews de este producto que se suben a la web',
    	'prices' => '95900',
    	'quantity' => '304',
    ...
    Sales::create([
        ...
        'title' => '',
    	'description' => 
    	'Auriculares bluetooth i12 TWS inalámbricos de color blanco , rojo , verde , gris . Toque los auriculares de control.
    ...
    Sales::create([
    	...
    	'description' => 
    	'Logitech G633 Artemis Spectrum, Diadema Gamer RGB / Sonido 7.1 Dolby
